    ...
    return (
      <div className="tutorial-wrapper">
        ...
        <p>
          ...
          Удаление слова из курса обучения и повтор слова в текущем уроке
          возмоны только если правильно его перевести.
        </p>
        <hr />
        <p>
          Приложение генерирует набор из старых и новых слов для урока на основе
          пользовательских предпочтений, указанных в настройках. Там же
          указывается сложность слов, необходимых для урока.
        </p>
        <hr />
